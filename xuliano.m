%% Funcoes transferencia discretizadas
...
%% Funcoes transferencia para perturbacao
...
%% Matrizes dinamicas G e  matrizes resposta livre H 
...
%% trajetorias de simulacao para referencia e perturbacao

r = [2*ones(1,6000);
     0*ones(1,1000) 1*ones(1,5000);
     0*ones(1,2000) 1*ones(1,4000)];
 
q = [zeros(1,3000) 100*ones(1,3000);
     zeros(1,4000) 1*ones(1,2000);
     zeros(1,5000) 1*ones(1,1000)];
%% Loop controle

for i = 2:t_sim
    
    % Calcular saÃ­da atual
