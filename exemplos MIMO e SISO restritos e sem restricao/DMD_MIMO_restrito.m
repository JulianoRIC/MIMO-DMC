...
A_full = [I1 zeros(Nu(1,1),Nu(2,1)) zeros(Nu(1,1),Nu(3,1));
     zeros(Nu(2,1),Nu(1,1)) I2 zeros(Nu(2,1),Nu(3,1))
     zeros(Nu(3,1),Nu(1,1)) zeros(Nu(3,1),Nu(2,1)) I3;
     -tril(ones(Nu(1,1))) zeros(Nu(1,1),Nu(2,1)) zeros(Nu(1,1),Nu(3,1));
     zeros(Nu(2,1),Nu(1,1)) -tril(ones(Nu(2,1))) zeros(Nu(2,1),Nu(3,1));
     zeros(Nu(3,1),Nu(1,1)) zeros(Nu(3,1),Nu(2,1)) -tril(ones(Nu(3,1)))];
 
A_semi = [I1 zeros(Nu(1,1),Nu(2,1)) zeros(Nu(1,1),Nu(3,1));
          zeros(Nu(2,1),Nu(1,1)) I2 zeros(Nu(2,1),Nu(3,1))
           zeros(Nu(3,1),Nu(1,1)) zeros(Nu(3,1),Nu(2,1)) I3
           -I1 zeros(Nu(1,1),Nu(2,1)) zeros(Nu(1,1),Nu(3,1));
          zeros(Nu(2,1),Nu(1,1)) -I2 zeros(Nu(2,1),Nu(3,1))
           zeros(Nu(3,1),Nu(1,1)) zeros(Nu(3,1),Nu(2,1)) -I3];
...
%     [Y] = Calculo_Ym(y_k,U,i);
    ...
    du = quadprog(Hqp,fqp,A_semi,b_semi);
